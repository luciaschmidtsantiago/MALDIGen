...
from dataloader.RKI_Manager import RKIManager, RKI
...
# Initialize the RKIManager
pickle_path = os.path.join(os.path.dirname(__file__), 'RKI.pkl')
manager = RKIManager(dataset_path, presaved=True, pickle_path=pickle_path)
...
species_dataset = RKI(species, preprocess_pipeline=preprocess_pipeline)
enterobacter_dataset = RKI(enterobacter_data, preprocess_pipeline=preprocess_pipeline)
